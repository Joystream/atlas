...
const SvgLogoAppleOnDark = forwardRef((props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
...
SvgLogoAppleOnDark.displayName = 'SvgLogoAppleOnDark'
const Memo = memo(SvgLogoAppleOnDark)
export { Memo as SvgLogoAppleOnDark }
