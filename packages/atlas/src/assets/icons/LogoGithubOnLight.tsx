...
const SvgLogoGithubOnLight = forwardRef((props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
...
SvgLogoGithubOnLight.displayName = 'SvgLogoGithubOnLight'
const Memo = memo(SvgLogoGithubOnLight)
export { Memo as SvgLogoGithubOnLight }
