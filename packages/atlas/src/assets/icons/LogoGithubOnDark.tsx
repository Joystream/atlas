...
const SvgLogoGithubOnDark = forwardRef((props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
...
SvgLogoGithubOnDark.displayName = 'SvgLogoGithubOnDark'
const Memo = memo(SvgLogoGithubOnDark)
export { Memo as SvgLogoGithubOnDark }
