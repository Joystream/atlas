...
const SvgActionOrderedList = forwardRef((props: SVGProps<SVGSVGElement>, ref: Ref<SVGSVGElement>) => (
...
SvgActionOrderedList.displayName = 'SvgActionOrderedList'
const Memo = memo(SvgActionOrderedList)
export { Memo as SvgActionOrderedList }
