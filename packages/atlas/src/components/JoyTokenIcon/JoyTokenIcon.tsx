      ...
      <Tooltip
        ...
        customContent={
          <TooltipText as="span" variant="t100">
            ...
            Gleev. It is used for trading Creator Tokens, NFTs and covering blockchain processing fees. It is also used
            for voting on proposals and partaking in council elections.{' '}
