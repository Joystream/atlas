...
const SvgSocialMediaTelegramMonochrome = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(SvgSocialMediaTelegramMonochrome)
export { Memo as SvgSocialMediaTelegramMonochrome }
