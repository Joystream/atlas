...
const SvgSocialMediaWhatsAppOnDark = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(SvgSocialMediaWhatsAppOnDark)
export { Memo as SvgSocialMediaWhatsAppOnDark }
