...
export const SvgSocialMediaFacebookOnLight = React.memo((props: React.SVGProps<SVGSVGElement>) => (
...
SvgSocialMediaFacebookOnLight.displayName = 'SvgSocialMediaFacebookOnLight'
