...
const SvgSocialMediaFacebookOnLight = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(SvgSocialMediaFacebookOnLight)
export { Memo as SvgSocialMediaFacebookOnLight }
