...
const SvgSocialMediaTwitterMonochrome = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(SvgSocialMediaTwitterMonochrome)
export { Memo as SvgSocialMediaTwitterMonochrome }
