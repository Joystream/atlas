...
const SvgSocialMediaFacebookOnDark = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(SvgSocialMediaFacebookOnDark)
export { Memo as SvgSocialMediaFacebookOnDark }
