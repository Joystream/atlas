...
const SvgSocialMediaTwitterOnLight = (props: SVGProps<SVGSVGElement>) => (
...
const Memo = memo(SvgSocialMediaTwitterOnLight)
export { Memo as SvgSocialMediaTwitterOnLight }
