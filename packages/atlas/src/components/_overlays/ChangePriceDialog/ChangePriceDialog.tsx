    ...
    >
      <>
        <Text variant="t200" secondary>
          Change price for your existing item. New price must be lower than the current one. If you want to rise the
          price up, you have to remove this item from sale and then start a new sale.
        </Text>
        <StyledTextField
          type="text"
