...
import { LegalLastUpdateText, LegalList, LegalListItem, LegalParagraph } from '../LegalText'
...
export const TermsOfService: FC = () => {
  return (
    <div>
      ...
      <TermsOfServiceWithoutPreamble />
    </div>
  )
}

export const TermsOfServiceWithoutPreamble: FC<{ standalone?: boolean }> = ({ standalone }) => (
  <>
    <LegalParagraph header skipMargin={standalone}>
      1. Agreement to Terms
    </LegalParagraph>
    <LegalParagraph>
      By using Our Software, the User is agreeing to be bound by this Agreement. If you are acting on behalf of another
      company or an employer, you must have the rights to act on their behalf.
    </LegalParagraph>
    <LegalParagraph header>2. Changes to Terms</LegalParagraph>
    <LegalParagraph>
      This Agreement may be modified or updated at the sole discretion of Company without notice. Your continued use of
      our Software is confirmation of your acceptance of the latest Agreement.
    </LegalParagraph>
    ...
    <LegalParagraph>
      Under no circumstance will Company take any responsibility for loss resulting from losing access to Membership or
      Keys.
    </LegalParagraph>
    ...
    <LegalParagraph>
      ...
      contractors, employees or owners be liable for any damage or loss of any kind to User resulting of clicking links,
      following guides, using software or doing anything else recommended by Company.
    </LegalParagraph>
