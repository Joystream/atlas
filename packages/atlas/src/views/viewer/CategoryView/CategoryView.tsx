...
// import { ExtendedVideoCategoryFieldsFragment } from '@/api/queries/__generated__/fragments.generated'
...
//   featuredVideos: GetCategoriesFeaturedVideosQuery['videoCategoryById']['featuredVideos'] = []
// ) => {
