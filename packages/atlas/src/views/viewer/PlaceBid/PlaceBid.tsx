                ...
                {type === 'auction' ? (
                  <>
                    ...
                    <MinimumBidWrapper>
                      <MinimumBid>
                        ...
                        <StyledJoyTokenIcon variant="silver" size={24} /> <Text variant="h400">{MINIMUM_BID}</Text>
                      </MinimumBid>
                      <div>
                    ...
                    <TextField
                      ...
                      nodeStart={<StyledJoyTokenIcon variant="silver" size={24} />}
                  ...
                  <MinimumBidWrapper>
                    <MinimumBid>
                      ...
                      <StyledJoyTokenIcon variant="silver" size={24} /> <Text variant="h400">{FIXED_PRICE}</Text>
                    </MinimumBid>
                  </MinimumBidWrapper>
                )}
                <Divider />
