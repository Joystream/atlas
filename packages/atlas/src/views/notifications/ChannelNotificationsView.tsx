...
export const ChannelNotificationsView = () => {
  const headTags = useHeadTags('Channel notifications')
  ...
  return (
    <>
      {headTags}
      <NotificationsViewContent type="channel" {...useNotificationsParams} unreadNumber={unreadNumber} />
    </>
  )
}
