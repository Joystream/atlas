...
const mappedColors = {
  blue: oldColors.blue[500],
  lightBlue: oldColors.blue[200],
  red: oldColors.secondary.alert[100],
  yellow: oldColors.secondary.warning[100],
  green: oldColors.secondary.success[100],
}
