...
export const SvgSocialMediaFacebookOnDark = React.memo((props: React.SVGProps<SVGSVGElement>) => (
...
SvgSocialMediaFacebookOnDark.displayName = 'SvgSocialMediaFacebookOnDark'
