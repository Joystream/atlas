...
import { useAuthorizedUser, useDisplayDataLostWarning, useDrafts, useEditVideoSheet, useUploadsManager } from '@/hooks'
...
export const StudioSidenav: React.FC = () => {
  ...
  const assetsInProgress = chanelUploadsState.filter((asset) => asset.lastStatus === 'inProgress')
